...
import { useVirtualInterview } from "../../hooks/job/useVirtualInterview";
...
function VirtualInterview({ application, onNext }) {
  const { register, handleSubmit, reset } = useForm();
  const { virtualInterview, loading } = useVirtualInterview();
  ...
  const onSubmit = async (data) => {
    ...
    const res = await virtualInterview(payload);
    console.log("Virtual Interview Response:", res);
