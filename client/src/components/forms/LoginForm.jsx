...
>
  ...
  <div className="absolute inset-0 bg-white/30 dark:bg-black/40 backdrop-blur-sm z-0" />

  <div className="relative z-10 
                  bg-white dark:bg-gray-800 
                  bg-opacity-90 dark:bg-opacity-90 
                  backdrop-blur-md rounded-3xl shadow-2xl 
                  w-full max-w-6xl flex flex-col md:flex-row overflow-hidden">
    {/* Left Panel */}
    <div className="w-full md:w-1/2 p-10">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm font-digi">Sign in to your account</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        {/* Email */}
        <div>
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block font-digi">
            E-mail
          </label>
          <div className="flex items-center gap-2 px-4 py-3 
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-sm font-digi dark:placeholder-gray-400"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2 px-4 py-3 
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-sm dark:placeholder-gray-400"
            />
            <button
              type="button"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 text-white bg-gradient-to-r from-purple-500 to-blue-500 
                     rounded-xl shadow-md font-semibold text-sm hover:opacity-90 
                     transition disabled:opacity-60 font-digi"
        >
    ...
    <div className="hidden md:flex w-1/2 
                    bg-gradient-to-tr from-[#6b21a8] to-[#3b82f6] 
                    items-center justify-center relative text-white p-10">
